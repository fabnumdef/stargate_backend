...
export const EXPORT_CSV_VISITORS = [
  ...
  { label: 'SERVICE', value: '' },
  { label: 'VALIDITE ACCES', value: '' },
  { label: 'DATE DEBUT VALIDITE', value: 'request.from' },
  { label: 'DATE FIN VALIDITE', value: 'request.to' },
  { label: 'NATIONALITE', value: 'nationality' },
  { label: 'PAYS DE NAISSANCE', value: '' },
  { label: 'LIEU(X) DE TRAVAIL', value: '' },
  { label: 'ORIGINE', value: 'isInternal' },
  { label: 'TYPE D\'EMPLOYE', value: 'employeeType' },
  { label: 'DATE CRIBLAGE', value: 'dateScreening' },
  { label: 'ACCES HOMET', value: '' },
  { label: 'ACCES CACHIN', value: '' },
  { label: 'ACCES COMNORD', value: '' },
  { label: 'ACCES NARDOUET', value: '' },
  { label: 'ACCES ILOT SUD', value: '' },
  { label: 'ACCES H3', value: '' },
  { label: 'ADRESSE MAIL UNITE CONTRACTANTE', value: '' },
  { label: 'DROIT DE CONDUITE', value: '' },
  { label: 'PROFIL D\'ACCES', value: '' },
  { label: 'COMMENTAIRE', value: '' },
  { label: 'FREQUENCE DE VISITE', value: '' },
  { label: 'ENVOI MAIL', value: '' },
  { label: 'IMPORTATION PROTECTER', value: '' },
  { label: 'REFERENCE HABILITATION OU C.E.', value: '' },
  { label: 'DATE FIN DE VALIDITE HABILITATION OU C.E.', value: '' },
  { label: 'EXTENSION PHOTO', value: '' },
  { label: 'TYPE DE BADGE', value: 'typeBadge' },
  { label: 'NOM PERSONNE VISITEE', value: '' },
  { label: 'PRENOM PERSONNE VISITEE', value: '' },
  { label: 'N° DEMANDE', value: 'request._id' },
  { label: 'CODE ACTION', value: '' },
